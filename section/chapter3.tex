...
\begin{lstlisting}[caption=Cara penggunaan library kalkulator,label={lst:kelasngitung}]
class Ngitung:
...
\begin{lstlisting}[caption=Cara penggunaan library kalkulator,label={lst:instanngitung}]
import ngitung
